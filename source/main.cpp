...
TemporalGraph * build(char * argv[]) {
    ...
    int build_graph_start_time = currentTime();
    TemporalGraph * Graph = new TemporalGraph(argv[1], (char *)"Undirected");
    int build_graph_end_time = currentTime();
...
int main(int argc, char * argv[]) {
    ...
    if (std::strcmp(argv[4], "Online") == 0) {
        ...
        int online_search_start_time = currentTime();
        online(Graph, argv[2], argv[3]);
        int online_search_end_time = currentTime();
    ...
    if (std::strcmp(argv[4], "Baseline") == 0) {
        ...
        int index_construction_start_time = currentTime();
        BaselineIndex *Index = new BaselineIndex(Graph);
        int index_construction_end_time = currentTime();
        ...
        int query_start_time = currentTime();
        baseline(Index, vertex_num, argv[2], argv[3]);
        int query_end_time = currentTime();
